...
const getPhotoUrl = (photo) => {
  if (!photo || typeof photo !== 'string' || photo.includes('undefined')) return null;
                      ...
                      <div className="item-details">
                        {editingSubjectId === sub.id ? (
                          ...
                          <>
                            ...
                            <p>
                              <strong>Statut :</strong> <span style={getStatutStyle(subjectDetails[sub.id]?.statut)}>
                                {subjectDetails[sub.id]?.statut}
                              </span>
                            </p>
                            {subjectDetails[sub.id]?.image && getPhotoUrl(subjectDetails[sub.id].image) ? (
                              <img src={getPhotoUrl(subjectDetails[sub.id].image)} alt="Image matière" className="media" />
                            ) : (
                              <p>Aucune image</p>
                            )}
                            <div>
